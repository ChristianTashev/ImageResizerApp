...
namespace ImageResizerApp
{
    public partial class ImageResizerForm : Form
    {
        ...
        private void ResizeSequentialButton_Click(object sender, EventArgs e)
        {
            ...
            var sequentiallyDownsizedImage  = ImageResizer.ResizeImage(originalImageAsBitmap, scaleFactor);
        ...
        private void ResizeParallelButton_Click(object sender, EventArgs e)
        {
            ...
            var originalImageAsBitmap       = (Bitmap)originalPictureBox.Image;
            var resizedImageAsBitmap        = ConcurrentImageResizer.ResizeInParallel(originalImageAsBitmap, newImageWidth, newImageHeight);
